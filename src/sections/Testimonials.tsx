  ...
  return (
    <div className="py-16 lg:py-24">
      <div className="container">
        <SectionHeader
          eyebrow="Collègues et Supérieurs témoignent"
          title="Ce que mes Collègues de travail ont à dire sur moi"
          description="Témoignage à l'appui. Histoire d'être sûr (sait-on jamais.. )"
        />
